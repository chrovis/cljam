...
(defn convert
  ...
  (with-open [rdr (io-core/reader in)
              wtr (io-core/writer out)]
    (cond
      (io-core/sam-writer? wtr) (_convert! rdr wtr num-block num-write-block sam-write-alignments)
      (io-core/bam-writer? wtr) (_convert! rdr wtr num-block num-write-block bam-write-alignments)
