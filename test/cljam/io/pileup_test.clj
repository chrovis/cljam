...
(deftest parse-bases-col
  (testing "without-ref"
    (are [?in ?out]
         (= (mapv #(into {:pos -1, :qname nil :alignment nil} %) ?out)
  ...
  (testing "without-ref"
    (are [?in ?out]
      ...
      "chr1\t10\tN\t1\tA\tI" {:rname "chr1", :pos 10, :ref \N, :count 1,
                              :pile [{:start? false, :mapq nil, :base \A, :qual 40, :reverse? false, :end? false, :insertion nil, :deletion nil, :pos -1, :qname nil, :alignment nil}]}
      "chr1\t10\tN\t2\taA\tIB" {:rname "chr1", :pos 10, :ref \N, :count 2,
                                :pile [{:start? false, :mapq nil, :base \A, :qual 40, :reverse? true, :end? false, :insertion nil, :deletion nil, :pos -1, :qname nil, :alignment nil}
                                       {:start? false, :mapq nil, :base \A, :qual 33, :reverse? false, :end? false, :insertion nil, :deletion nil, :pos -1, :qname nil, :alignment nil}]}
      "chr1\t10\tN\t2\taA-2NN$\tIB" {:rname "chr1", :pos 10, :ref \N, :count 2,
                                     :pile [{:start? false, :mapq nil, :base \A, :qual 40, :reverse? true, :end? false, :insertion nil, :deletion nil, :pos -1, :qname nil, :alignment nil}
                                            {:start? false, :mapq nil, :base \A, :qual 33, :reverse? false, :end? true, :insertion nil, :deletion 2, :pos -1, :qname nil, :alignment nil}]}))
  (testing "with-ref"
    (are [?in ?out]
         (= ?out (rec->map (#'plpio/parse-pileup-line ?in)))
