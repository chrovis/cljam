...
(fact "about pileup"
  (pileup/pileup test-sam) => '({:rname "ref",  :pos 7,  :n 1}
                                ...
                                {:rname "ref",  :pos 16, :n 3}
                                {:rname "ref",  :pos 17, :n 3}
                                {:rname "ref",  :pos 18, :n 3}
                                {:rname "ref",  :pos 19, :n 2}
                                {:rname "ref",  :pos 20, :n 2}
                                {:rname "ref",  :pos 21, :n 2}
                                {:rname "ref",  :pos 22, :n 2}
                                ...
                                {:rname "ref2", :pos 10, :n 4}
                                {:rname "ref2", :pos 11, :n 4}
                                {:rname "ref2", :pos 12, :n 5}
                                {:rname "ref2", :pos 13, :n 5}
                                {:rname "ref2", :pos 14, :n 6}
                                {:rname "ref2", :pos 15, :n 6}
                                {:rname "ref2", :pos 16, :n 6}
                                {:rname "ref2", :pos 17, :n 6}
                                {:rname "ref2", :pos 18, :n 6}
                                {:rname "ref2", :pos 19, :n 6}
                                {:rname "ref2", :pos 20, :n 6}
                                {:rname "ref2", :pos 21, :n 5}
                                {:rname "ref2", :pos 22, :n 5}
                                {:rname "ref2", :pos 23, :n 4}
                                {:rname "ref2", :pos 24, :n 4}
                                {:rname "ref2", :pos 25, :n 4}
                                {:rname "ref2", :pos 26, :n 4}
                                {:rname "ref2", :pos 27, :n 4}))
